...
parser.add_argument('--num_losses', type=int, default=3)
...
parser.add_argument('--refine_inter', action="store_true")
parser.add_argument("--refine_crop", action="store_true")
...
parser.add_argument("--no_iterative_learning", action="store_true")


# saving
parser.add_argument("--save_predictions", action="store_true")
parser.add_argument("--save_csv", action="store_true")
parser.add_argument("--save_test_dir", default='/home/hao/Hao', type=str)
